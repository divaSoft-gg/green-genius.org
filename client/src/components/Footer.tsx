        ...
        <footer className="py-8 flex flex-col items-center sm:p-6 dark:bg-gray-800 ">
            <div className="  w-full">
                <div className="md:flex md:justify-between text-center md:text-left">
                    <div className="mb-6 md:mb-0">
                        <Link href="#" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Grren-Genius</span>
                        </Link>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Green-Genius™</a>. All Rights Reserved.
                    </span>
