...
export default function MobileNavbar({ navItems }: Readonly<{ navItems: NavItemsProps[] }>) {
    const [isMenuOpen, setIsMenuOpen] = useReducer((current) => !current, false)

    return (
        <Navbar onMenuOpenChange={setIsMenuOpen} isMenuOpen={isMenuOpen} position="sticky" maxWidth="2xl">
