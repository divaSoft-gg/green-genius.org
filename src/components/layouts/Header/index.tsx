...
const Header = () => {
    ...
    return (
        ...
        //                 <button
        //                     className="flex items-center justify-center p-2 text-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200"
        ...
        //                         <button className="flex items-center w-full text-left" onClick={()=> {i18n.changeLanguage(code); handleDropdownToggle()}}
        //                             >
        ...
        //             </Button>
        //         </div>
        //         <div id="navbar-cta" className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isMenuOpen
        //             ? 'block' : 'hidden' }`}>
        //             <ul
        ...
        <SharedSection className="flex flex-wrap items-center justify-between !py-3">
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <div className={`relative ${isRTL ? 'ml-2' : 'mr-2'}`}>
              <button
                className="flex items-center justify-center p-2 text-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200"
                onClick={handleDropdownToggle}>
                <GlobeIcon />
