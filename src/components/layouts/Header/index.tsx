...
<nav className="bg-white border-gray-200 ">
    <SharedSection className=" flex flex-wrap items-center justify-between !py-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <Button type="button"
                className="text-blue-500 bg-blue-100  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center ">
                Get started
            </Button>
