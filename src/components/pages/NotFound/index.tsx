  ...
  return (
    <section className="min-h-screen bg-white  flex items-center justify-center py-8 px-4 mx-auto max-w-screen-xl lg:py-11 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <Button to="/" className="inline-flex text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  my-4">Back to Homepage</Button>
        </div>   
    </section>
  )
}
