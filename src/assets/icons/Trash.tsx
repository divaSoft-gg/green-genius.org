export default function Trash() {
    return (
        <svg  viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-text-primary lg:w-6 lg:h-6 " fill="currentColor">
            <path d="M9.17065 4C9.58249 2.83481 10.6937 2 11.9999 2C13.3062 2 14.4174 2.83481 14.8292 4" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M20.5 6H3.49988" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
