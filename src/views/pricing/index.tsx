...
import { cn, fetchExchangeRates, getConvertedAmount, getCurrentDay } from "../../common/utils";
                    ...
                    <div className="flex flex-row flex-wrap">
                        {
                            pricingPlans.map((plan: pricingPlansType, index: number) => {
                                ...
                                const showBorderRadiusForLastCard = (index === pricingPlans.length - 1) && !isMobile;

                                return (
                                    <div key={index}
                                        className={cn(
                                            'flex flex-col w-56 gap-6 p-4 border border-collapse grow bg-white',
